...
* Добавить темную тему (est: 2 часа; fact: 1)

#### Логика и состояние

* Проверка и тестирование работы совместно с Cart (est: 2 часа; fact: 1)

#### Работа с сетью (Реальные данные)

* Рефакторинг NetworkService на async/await (est: 4 часа; fact: 2 часа) - к сожалению пришлось реализовывать в прошлых ПР
* Загрузка реальных данных, имплементация в сервисы (est: 2 часа; fact: 2) - к сожалению пришлось реализовывать в прошлых ПР
